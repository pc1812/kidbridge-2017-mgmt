...
<head>
    ...
    <title>绘本跟读明细列表 | kidbridge manage</title>
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header" style="margin: 10px 24px;">
                    <form method="get" action="/data/book/sign/detail/list">
                        ...
                        <div class="ibox-content">
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty detailList }">
                                            <c:forEach items="${detailList }" var="detail">
                                                <tr>
                                                    <td>${detail.userBook.user.id }</td>
                                                    <td>${detail.userBook.user.nickname }</td>
                                                    <td>${detail.userBook.book.id }</td>
                                                    <td>${detail.userBook.book.name }</td>
                                                    <td>
                                                        <fmt:formatDate value="${detail.createTime }" pattern="yyyy-MM-dd HH:mm:ss" />
                                                    </td>
                                                    <td>
                                                        <fmt:formatDate value="${detail.updateTime }" pattern="yyyy-MM-dd HH:mm:ss" />
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </c:when>
                            ...
                            <div style="height: 35px;">
                                <div style="float: left;">
                                    <a href="/data/book/sign/detail/export/?beginDate=${param.beginDate }&endDate=${param.endDate }" class="btn btn-primary">生成报表</a>
                                </div>
                                <div style="float: right; display: ${page.numberList.size() == 0 ? "none" : "block" }">
                                    <ul class="pagination">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <li>
                                                    <a href="/data/book/sign/detail/list/?beginDate=${param.beginDate }&endDate=${param.endDate }&page=${page.min }" aria-label="Previous"><i class="fa fa-angle-double-left" aria-hidden="true"></i></a>
                                                </li>
                                                <li>
                                                    <a href="/data/book/sign/detail/list/?beginDate=${param.beginDate }&endDate=${param.endDate }&page=${param.page - 1 }" aria-label="Previous"><i class="fa fa-angle-left" aria-hidden="true"></i></a>
                                                </li>
                                            </c:otherwise>
                                        </c:choose>
                                        ...
                                        <c:forEach items="${page.numberList }" var="number">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <li>
                                                        <a href="/data/book/sign/detail/list/?beginDate=${param.beginDate }&endDate=${param.endDate }&page=${number }">
                                                                ${number }
                                                        </a>
                                                    </li>
                                                </c:otherwise>
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <li>
                                                    <a href="/data/book/sign/detail/list/?beginDate=${param.beginDate }&endDate=${param.endDate }&page=${empty param.page ? param.page + 1 + 1 : param.page + 1 }" aria-label="Next"><i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                                </li>
                                                <li>
                                                    <a href="/data/book/sign/detail/list/?beginDate=${param.beginDate }&endDate=${param.endDate }&page=${page.max }" aria-label="Next"><i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                                                </li>
                                            </c:otherwise>
                                        </c:choose>
                                    </ul>
